...
class SoilNCgraph extends StatefulWidget {
  SoilNCgraph({Key? key}) : super(key: key);

  @override
  _SoilNCgraphState createState() => _SoilNCgraphState();
}

class _SoilNCgraphState extends State<SoilNCgraph> {
