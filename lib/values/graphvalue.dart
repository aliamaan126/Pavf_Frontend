...
class _GraphState extends State<graph> {
  ...
  Widget _buildTextScreen(int index, int speedValue) {
    return Column(
      ...
      children: [
        SizedBox(
            height: 50), // Adjusted height between ToggleSwitch and LineChart
        ToggleSwitch(
          minWidth: 90.0,
          cornerRadius: 100.0,
          activeBgColors: [
        ...
        SizedBox(height: 20), // Adjusted height after ToggleSwitch
        Expanded(
          child: Center(
            child: Container(
              ...
              child: LineChart(
                LineChartData(
                    ...
                    // Example configurations can be found in fl_chart documentation
